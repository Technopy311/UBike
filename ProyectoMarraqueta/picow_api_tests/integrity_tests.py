...
ALLOWED_TESTS = (
    create_full_request, 
    test_recv_not_post_request, 
    test_invalid_json_data_format_post_request, 
    test_valid_json_data_format_but_invalid_data,
    test_valid_json_data_with_bad_ip_address,
    test_valid_request_but_no_bicycle,
    test_valid_request_but_no_place,
    test_valid_request_with_one_place,
    test_valid_request_with_one_place_but_2_bicycles,
    test_valid_request_with_five_places_and_two_bicycles_only_saving,
    test_valid_request_with_five_places_and_two_bicycles_saving_and_removing
    )